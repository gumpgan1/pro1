...
public class LoginController {
	...
	public String reg(Model model, @RequestParam("username") String username,
		...
		try {
			Map<String, String> map = snUserService
	...
	/**
	 * 测试方法入口 testLin.do? pathvariable
	 * 
	 * @throws IOException
	 */
	@RequestMapping(path = { "/testLin" }, method = { RequestMethod.GET })
	@ResponseBody
	public String testLin(Model model, @RequestParam("min") Integer min,
			@RequestParam("max") Integer max, HttpServletResponse response)
			throws IOException {
		...
		response.setHeader("Content-Disposition",
				"attachment;filename=" + UUID.randomUUID() + ".xlsx");
